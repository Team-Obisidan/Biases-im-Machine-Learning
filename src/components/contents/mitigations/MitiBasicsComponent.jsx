				...
				<Footnotes>
								{({Footnote, getFootnotes}) => (
									<div style={{textAlign: 'left'}}>
										...
										<br />
										<br />
										Biases können in zwei Kategorien eingeteilt werden – User Biases (engl. für Anwender-Verzerrungen) und Content Biases (engl. für inhaltliche Verzerrungen). Bei einem User Bias handelt es sich um die Verzerrung eines Anwenders, der Informationen erhält. 
										{" "}
										Es wird angenommen, dass Attribute, die einen Anwender maßgeblich charakterisieren – so z.B. das Geschlecht oder die ethnische Herkunft – gesichert sind. Ein User Bias liegt dann vor, wenn solche geschützten Attribute das Ergebnis eines Algorithmus beeinflussen und damit in direkten Zusammenhang die Person.<Footnote i={7} desc="Vgl. Pitoura u. a. 2018, S. 17"/> 
										<br />
										<br />
										Content Biases hingegen lassen sich nach der Eigenschaft klassifizieren, dass ein Online Information Provider (OIP) verzerrte Ergebnisse liefert und diese – meist zu seinem Vorteil – verändert. Die Ergebnisse bleiben dabei unabhängig von einem Benutzer oder einer Benutzerin und werden durch den OIP festgelegt.<Footnote i={8} desc="Vgl. Pitoura u. a. 2018, S. 17"/>  
										<br />
										<br />
										...
										<br />
										<br />
										Dieser Sachverhalt der Content, bzw. User Biases kann als nicht fair betrachtet werden und spielt eine große Rolle bei der Diskussion um Fairness im maschinellen Lernen. Neben der Fairness spielen weitere Prinzipien eine Rolle im Machine Learning – so zum Beispiel jenes der Kausalität und Korrelation, welches im folgenden Abschnitt näher betrachtet wird.
										...
										{" "}
										Der Algorithmus schätzt demnach, dass eine Person mit schwarzer Hautfarbe eine höhere Wahrscheinlichkeit hat erneut strafrechtlich auffällig zu werden, als eine Person mit weißer Hautfarbe und den exakt gleichen Hintergrundparametern.<Footnote i={11} desc="Vgl. Lovejoy 2020"/>  
										<br />
										<br />
